...
subroutine phosib(  &
    ...
    !...local variables
    integer :: icconv, ic, ic1 ! iteration loops
    real(r8) :: pco2cas_tmp, co2cas_tmp !new addition to iteration loop
    !----------------------------------
    !     SET LOCAL VARIABLES
    !----------------------------------
    ...
    do ic = 1, numic
        ...
        !.. uncomment for prognostic canopy air space
        co2cas_tmp = (co2cas + (dtsib/co2cap) *  & 
                (resp_cas - assimy(ic) + co2m*gah2o) )  &
                / (1+dtsib*gah2o/ co2cap ) 

        !.. uncomment for diagnostic canopy air space for C13
        ! co2cas_tmp = co2m
  ...
  enddo !main iteration loop
    ...
    !.. uncomment to update to diagnsotic canopy air space for C13
    !co2cas=co2m
