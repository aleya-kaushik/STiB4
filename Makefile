...
#  LALIB = -lscalapack -lopenblas -lgfortran # -latlas -lf77blas
...
ifeq ($(NC),3)
  ...
  #INCLUDES =
  # On Cartesius, the INCLUDES var could be left empty as the paths in
  # CPATH would be included automatically.
