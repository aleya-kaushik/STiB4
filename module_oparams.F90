...
!-----------------------------------------------------------------
      ...
      ! Fire Parameters
       real(r4), parameter :: &
          ...
          !! Lindas values are different
          fire_leaff = 0.1, & ! 0.3 fire emission fraction removed from leaf pool
          fire_stwdf = 0.15, & ! 0.1 fire emission fraction removed from stwd pool
          fire_cdbf  = 0.25, & ! 0.2 fire emission fraction removed from cdb pool
          fire_metlf = 0.25, & ! 0.2 fire emission fraction removed from metl pool
          fire_strlf = 0.25    ! 0.2 fire emission fraction removed from strl pool
